-- Desafio 02 Função UDF
-- Criar um loop para verificar as notas de 1 ao 1000000 se existem ou não notas fiscais
...
WHILE @LIMITE_MINIMO <= @LIMITE_MAXIMO
	...
	SELECT @CONTADOR_NOTAS = COUNT(*) FROM [NOTAS FISCAIS] WHERE NUMERO = @LIMITE_MINIMO;
		IF @CONTADOR_NOTAS > 0
			BEGIN
			INSERT INTO @TABELA_NUMEROS VALUES(@LIMITE_MINIMO, 'É nota fiscal', ROUND(dbo.FaturamentoNota(@LIMITE_MINIMO),2) );
			END;
		ELSE
			BEGIN
