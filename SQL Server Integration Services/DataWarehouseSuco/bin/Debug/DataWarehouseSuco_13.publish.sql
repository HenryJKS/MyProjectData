...
GO
/*
The column [dbo].[Fato_001].[Unidade_Venida] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[Fato_001] DROP COLUMN [Unidade_Venida];


GO
ALTER TABLE [dbo].[Fato_001]
    ADD [Unidade_Vendida] FLOAT (53) NULL;
